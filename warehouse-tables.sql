...
SELECT "products"."description", "warehouse_product"."product_id", "warehouse_product"."warehouse_id", "warehouse"."warehouse"
...
SELECT "customers"."first_name", "customers"."id", "addresses"."customer_id", "addresses"."id", "orders"."address_id", "addresses"."id"
FROM "addresses"
